...
\setbeamercolor{itemize item}{fg=cyanPrimaire}
\setbeamercolor{itemize subitem}{fg=cyanPrimaire!80}
\setbeamercolor{itemize subsubitem}{fg=cyanPrimaire!60}
\setbeamercolor{item projected}{fg=white,bg=cyanPrimaire}
\setbeamercolor{subitem projected}{fg=white,bg=cyanPrimaire!80}
\setbeamercolor{subsubitem projected}{fg=white,bg=cyanPrimaire!60}
...
\setbeamercolor{block title}{fg=noirPrimaire,bg=grisPrimaire!20}
\setbeamercolor{button}{fg=white,bg=bleuFonceSecondaire!60}
\setbeamercolor{button border}{fg=bleuFonceSecondaire!80}
